...
import { ArrowRight, CheckCircle2, ClipboardList, Inbox, Lightbulb, FileCheck, UserPlus } from 'lucide-react'
...
const reviews = [
  ...
  { key: 'pendingProjectApplications', label: 'Project applications', action: 'Add people to teams', href: '/admin/project-applications', icon: UserPlus },
