...
export function adminPortalGroups(role: AdminRole): PortalNavGroup[] {
  return [
    ...
    { label: 'Club', items: [item('Projects', '/admin/projects', 'projects'), item('Events', '/admin/events', 'calendar'), ...(role === 'EDITOR' ? [] : [item('Members', '/admin/members', 'people'), item('Teams', '/admin/teams', 'people')]), item('Website pages', '/admin/pages', 'pages')] },
